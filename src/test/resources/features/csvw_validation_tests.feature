...
Feature: CSVW Validation Tests
  ...
  Scenario: manifest-validation#test001 Simple table
    Given I have a CSV file called "test001.csv"
  ...
  Scenario: manifest-validation#test005 Identifier references
    Given I have a CSV file called "test005.csv"
  ...
  Scenario: manifest-validation#test006 No identifiers
    Given I have a CSV file called "test006.csv"
  ...
  Scenario: manifest-validation#test007 Joined table with unique identifiers
    Given I have a CSV file called "test007.csv"
  ...
  Scenario: manifest-validation#test008 Microsyntax - internal field separator
    Given I have a CSV file called "test008.csv"
  ...
  Scenario: manifest-validation#test009 Microsyntax - formatted time
    Given I have a CSV file called "test009.csv"
  ...
  Scenario: manifest-validation#test010 Country-codes-and-names example
    Given I have a CSV file called "test010.csv"
  ...
  Scenario: manifest-validation#test011 tree-ops example with metadata
    Given I have a CSV file called "test011/tree-ops.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test011/tree-ops.csv"
    And I have a file called "test011/tree-ops.csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test011/tree-ops.csv-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
  ...
  Scenario: manifest-validation#test012 tree-ops example with directory metadata
    Given I have a CSV file called "test012/tree-ops.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test012/tree-ops.csv"
    And I have a file called "test012/csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test012/csv-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
  ...
  Scenario: manifest-validation#test013 tree-ops example from user metadata
    Given I have a CSV file called "tree-ops.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/tree-ops.csv"
    And I have a metadata file called "test013-user-metadata.json"
  ...
  Scenario: manifest-validation#test014 tree-ops example with linked metadata
    Given I have a CSV file called "test014/tree-ops.csv"
    ...
    And I have a file called "test014/linked-metadata.json" at the url "https://w3c.github.io/csvw/tests/test014/linked-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
  ...
  Scenario: manifest-validation#test015 tree-ops example with user and directory metadata
    Given I have a CSV file called "test015/tree-ops.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test015/tree-ops.csv"
    And I have a metadata file called "test015/user-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test015/user-metadata.json"
    And I have a file called "test015/csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test015/csv-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
  ...
  Scenario: manifest-validation#test016 tree-ops example with linked and directory metadata
    Given I have a CSV file called "test016/tree-ops.csv"
    And it has a Link header holding "<linked-metadata.json>; rel="describedby"; type="application/csvm+json""
    And it is stored at the url "https://w3c.github.io/csvw/tests/test016/tree-ops.csv"
    And I have a file called "test016/csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test016/csv-metadata.json"
    And I have a file called "test016/linked-metadata.json" at the url "https://w3c.github.io/csvw/tests/test016/linked-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
  ...
  Scenario: manifest-validation#test017 tree-ops example with file and directory metadata
    Given I have a CSV file called "test017/tree-ops.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test017/tree-ops.csv"
    And I have a file called "test017/tree-ops.csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test017/tree-ops.csv-metadata.json"
    And I have a file called "test017/csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test017/csv-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test018 tree-ops example with user, file and directory metadata
    Given I have a CSV file called "test018/tree-ops.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test018/tree-ops.csv"
    And I have a metadata file called "test018/user-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test018/user-metadata.json"
    And I have a file called "test018/tree-ops.csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test018/tree-ops.csv-metadata.json"
    And I have a file called "test018/csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test018/csv-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test023 dialect: header=false
    Given I have a CSV file called "tree-ops.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/tree-ops.csv"
    And I have a metadata file called "test023-user-metadata.json"
  ...
  Scenario: manifest-validation#test027 tree-ops minimal output
    Given I have a CSV file called "tree-ops.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/tree-ops.csv"
    And I have a metadata file called "test027-user-metadata.json"
  ...
  Scenario: manifest-validation#test028 countries.csv example
    Given I have a CSV file called "countries.csv"
  ...
  Scenario: manifest-validation#test030 countries.json example
    Given I have a metadata file called "countries.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/countries.json"
    And I have a file called "countries.csv" at the url "https://w3c.github.io/csvw/tests/countries.csv"
    And I have a file called "country_slice.csv" at the url "https://w3c.github.io/csvw/tests/country_slice.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test032 events-listing.csv example
    Given I have a metadata file called "test032/csv-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test032/csv-metadata.json"
    And I have a file called "test032/events-listing.csv" at the url "https://w3c.github.io/csvw/tests/test032/events-listing.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test033 events-listing.csv minimal output
    Given I have a metadata file called "test033/csv-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test033/csv-metadata.json"
    And I have a file called "test033/events-listing.csv" at the url "https://w3c.github.io/csvw/tests/test033/events-listing.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test034 roles example
    Given I have a metadata file called "test034/csv-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test034/csv-metadata.json"
    And I have a file called "test034/senior-roles.csv" at the url "https://w3c.github.io/csvw/tests/test034/senior-roles.csv"
    And I have a file called "test034/junior-roles.csv" at the url "https://w3c.github.io/csvw/tests/test034/junior-roles.csv"
    And I have a file called "test034/gov.uk/data/organizations.csv" at the url "https://w3c.github.io/csvw/tests/test034/gov.uk/data/organizations.csv"
    And I have a file called "test034/gov.uk/data/professions.csv" at the url "https://w3c.github.io/csvw/tests/test034/gov.uk/data/professions.csv"
    And I have a file called "test034/gov.uk/schema/junior-roles.json" at the url "https://w3c.github.io/csvw/tests/test034/gov.uk/schema/junior-roles.json"
    And I have a file called "test034/gov.uk/schema/senior-roles.json" at the url "https://w3c.github.io/csvw/tests/test034/gov.uk/schema/senior-roles.json"
    And I have a file called "test034/gov.uk/schema/organizations.json" at the url "https://w3c.github.io/csvw/tests/test034/gov.uk/schema/organizations.json"
    And I have a file called "test034/gov.uk/schema/professions.json" at the url "https://w3c.github.io/csvw/tests/test034/gov.uk/schema/professions.json"
    When I carry out CSVW validation
  ...
  Scenario: manifest-validation#test035 roles minimal
    Given I have a metadata file called "test035/csv-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test035/csv-metadata.json"
    And I have a file called "test035/senior-roles.csv" at the url "https://w3c.github.io/csvw/tests/test035/senior-roles.csv"
    And I have a file called "test035/junior-roles.csv" at the url "https://w3c.github.io/csvw/tests/test035/junior-roles.csv"
    And I have a file called "test035/gov.uk/data/organizations.csv" at the url "https://w3c.github.io/csvw/tests/test035/gov.uk/data/organizations.csv"
    And I have a file called "test035/gov.uk/data/professions.csv" at the url "https://w3c.github.io/csvw/tests/test035/gov.uk/data/professions.csv"
    And I have a file called "test035/gov.uk/schema/junior-roles.json" at the url "https://w3c.github.io/csvw/tests/test035/gov.uk/schema/junior-roles.json"
    And I have a file called "test035/gov.uk/schema/senior-roles.json" at the url "https://w3c.github.io/csvw/tests/test035/gov.uk/schema/senior-roles.json"
    And I have a file called "test035/gov.uk/schema/organizations.json" at the url "https://w3c.github.io/csvw/tests/test035/gov.uk/schema/organizations.json"
    And I have a file called "test035/gov.uk/schema/professions.json" at the url "https://w3c.github.io/csvw/tests/test035/gov.uk/schema/professions.json"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test036 tree-ops-ext example
    Given I have a CSV file called "test036/tree-ops-ext.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test036/tree-ops-ext.csv"
    And I have a file called "test036/tree-ops-ext.csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test036/tree-ops-ext.csv-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
  ...
  Scenario: manifest-validation#test037 tree-ops-ext minimal
    Given I have a CSV file called "test037/tree-ops-ext.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test037/tree-ops-ext.csv"
    And I have a file called "test037/tree-ops-ext.csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test037/tree-ops-ext.csv-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
  ...
  Scenario: manifest-validation#test038 inherited properties propagation
    Given I have a metadata file called "test038-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test038-metadata.json"
    And I have a file called "test038.csv" at the url "https://w3c.github.io/csvw/tests/test038.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test039 valid inherited properties
    Given I have a metadata file called "test039-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test039-metadata.json"
    And I have a file called "test039.csv" at the url "https://w3c.github.io/csvw/tests/test039.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test040 invalid null
    Given I have a metadata file called "test040-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test040-metadata.json"
    And I have a file called "test040.csv" at the url "https://w3c.github.io/csvw/tests/test040.csv"
    When I carry out CSVW validation
    Then there should not be errors
  ...
  Scenario: manifest-validation#test041 invalid lang
    Given I have a metadata file called "test041-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test041-metadata.json"
    And I have a file called "test041.csv" at the url "https://w3c.github.io/csvw/tests/test041.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test042 invalid textDirection
    Given I have a metadata file called "test042-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test042-metadata.json"
    And I have a file called "test042.csv" at the url "https://w3c.github.io/csvw/tests/test042.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test043 invalid separator
    Given I have a metadata file called "test043-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test043-metadata.json"
    And I have a file called "test043.csv" at the url "https://w3c.github.io/csvw/tests/test043.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test044 invalid ordered
    Given I have a metadata file called "test044-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test044-metadata.json"
    And I have a file called "test044.csv" at the url "https://w3c.github.io/csvw/tests/test044.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test045 invalid default
    Given I have a metadata file called "test045-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test045-metadata.json"
    And I have a file called "test045.csv" at the url "https://w3c.github.io/csvw/tests/test045.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test046 invalid dataype
    Given I have a metadata file called "test046-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test046-metadata.json"
    And I have a file called "test046.csv" at the url "https://w3c.github.io/csvw/tests/test046.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test047 invalid aboutUrl
    Given I have a metadata file called "test047-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test047-metadata.json"
    And I have a file called "test047.csv" at the url "https://w3c.github.io/csvw/tests/test047.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test048 invalid propertyUrl
    Given I have a metadata file called "test048-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test048-metadata.json"
    And I have a file called "test048.csv" at the url "https://w3c.github.io/csvw/tests/test048.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test049 invalid valueUrl
    Given I have a metadata file called "test049-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test049-metadata.json"
    And I have a file called "test049.csv" at the url "https://w3c.github.io/csvw/tests/test049.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test059 dialect: invalid commentPrefix
    Given I have a metadata file called "test059-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test059-metadata.json"
    And I have a file called "tree-ops.csv" at the url "https://w3c.github.io/csvw/tests/tree-ops.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test060 dialect: invalid delimiter
    Given I have a metadata file called "test060-metadata.json"
  ...
  Scenario: manifest-validation#test061 dialect: invalid doubleQuote
    Given I have a metadata file called "test061-metadata.json"
  ...
  Scenario: manifest-validation#test062 dialect: invalid encoding
    Given I have a metadata file called "test062-metadata.json"
  ...
  Scenario: manifest-validation#test063 dialect: invalid header
    Given I have a metadata file called "test063-metadata.json"
  ...
  Scenario: manifest-validation#test065 dialect: invalid headerRowCount
    Given I have a metadata file called "test065-metadata.json"
  ...
  Scenario: manifest-validation#test066 dialect: invalid lineTerminators
    Given I have a metadata file called "test066-metadata.json"
  ...
  Scenario: manifest-validation#test067 dialect: invalid quoteChar
    Given I have a metadata file called "test067-metadata.json"
  ...
  Scenario: manifest-validation#test068 dialect: invalid skipBlankRows
    Given I have a metadata file called "test068-metadata.json"
  ...
  Scenario: manifest-validation#test069 dialect: invalid skipColumns
    Given I have a metadata file called "test069-metadata.json"
  ...
  Scenario: manifest-validation#test070 dialect: invalid skipInitialSpace
    Given I have a metadata file called "test070-metadata.json"
  ...
  Scenario: manifest-validation#test071 dialect: invalid skipRows
    Given I have a metadata file called "test071-metadata.json"
  ...
  Scenario: manifest-validation#test072 dialect: invalid trim
    Given I have a metadata file called "test072-metadata.json"
  ...
  Scenario: manifest-validation#test073 invalid @language
    Given I have a metadata file called "test073-metadata.json"
  ...
  Scenario: manifest-validation#test074 empty tables
    Given I have a metadata file called "test074-metadata.json"
  ...
  Scenario: manifest-validation#test075 invalid tableGroup tableDirection
    Given I have a metadata file called "test075-metadata.json"
  ...
  Scenario: manifest-validation#test076 invalid table tableDirection
    Given I have a metadata file called "test076-metadata.json"
  ...
  Scenario: manifest-validation#test077 invalid tableGroup @id
    Given I have a metadata file called "test077-metadata.json"
  ...
  Scenario: manifest-validation#test078 invalid table @id
    Given I have a metadata file called "test078-metadata.json"
  ...
  Scenario: manifest-validation#test079 invalid schema @id
    Given I have a metadata file called "test079-metadata.json"
  ...
  Scenario: manifest-validation#test080 invalid column @id
    Given I have a metadata file called "test080-metadata.json"
  ...
  Scenario: manifest-validation#test081 invalid dialect @id
    Given I have a metadata file called "test081-metadata.json"
  ...
  Scenario: manifest-validation#test082 invalid template @id
    Given I have a metadata file called "test082-metadata.json"
  ...
  Scenario: manifest-validation#test083 invalid tableGroup @type
    Given I have a metadata file called "test083-metadata.json"
  ...
  Scenario: manifest-validation#test084 invalid table @type
    Given I have a metadata file called "test084-metadata.json"
  ...
  Scenario: manifest-validation#test085 invalid schema @type
    Given I have a metadata file called "test085-metadata.json"
  ...
  Scenario: manifest-validation#test086 invalid column @type
    Given I have a metadata file called "test086-metadata.json"
  ...
  Scenario: manifest-validation#test087 invalid dialect @type
    Given I have a metadata file called "test087-metadata.json"
  ...
  Scenario: manifest-validation#test088 invalid transformation @type
    Given I have a metadata file called "test088-metadata.json"
  ...
  Scenario: manifest-validation#test089 missing tables in TableGroup
    Given I have a metadata file called "test089-metadata.json"
  ...
  Scenario: manifest-validation#test090 missing url in Table
    Given I have a metadata file called "test090-metadata.json"
  ...
  Scenario: manifest-validation#test092 invalid JSON
    Given I have a metadata file called "test092-metadata.json"
  ...
  Scenario: manifest-validation#test093 undefined properties
    Given I have a metadata file called "test093-metadata.json"
  ...
  Scenario: manifest-validation#test094 inconsistent array values: tables
    Given I have a metadata file called "test094-metadata.json"
  ...
  Scenario: manifest-validation#test095 inconsistent array values: transformations
    Given I have a metadata file called "test095-metadata.json"
  ...
  Scenario: manifest-validation#test096 inconsistent array values: columns
    Given I have a metadata file called "test096-metadata.json"
  ...
  Scenario: manifest-validation#test097 inconsistent array values: foreignKeys
    Given I have a metadata file called "test097-metadata.json"
  ...
  Scenario: manifest-validation#test098 inconsistent array values: tables
    Given I have a metadata file called "test098-metadata.json"
  ...
  Scenario: manifest-validation#test099 inconsistent array values: transformations
    Given I have a metadata file called "test099-metadata.json"
  ...
  Scenario: manifest-validation#test100 inconsistent array values: columns
    Given I have a metadata file called "test100-metadata.json"
  ...
  Scenario: manifest-validation#test101 inconsistent array values: foreignKeys
    Given I have a metadata file called "test101-metadata.json"
  ...
  Scenario: manifest-validation#test102 inconsistent link values: @id
    Given I have a metadata file called "test102-metadata.json"
  ...
  Scenario: manifest-validation#test103 inconsistent link values: url
    Given I have a metadata file called "test103-metadata.json"
  ...
  Scenario: manifest-validation#test104 invalid columnReference
    Given I have a metadata file called "test104-metadata.json"
  ...
  Scenario: manifest-validation#test105 invalid primaryKey
    Given I have a metadata file called "test105-metadata.json"
  ...
  Scenario: manifest-validation#test106 invalid dialect
    Given I have a metadata file called "test106-metadata.json"
  ...
  Scenario: manifest-validation#test107 invalid tableSchema
    Given I have a metadata file called "test107-metadata.json"
  ...
  Scenario: manifest-validation#test108 invalid reference
    Given I have a metadata file called "test108-metadata.json"
  ...
  Scenario: manifest-validation#test109 titles with invalid language
    Given I have a metadata file called "test109-metadata.json"
  ...
  Scenario: manifest-validation#test110 titles with non-string values
    Given I have a metadata file called "test110-metadata.json"
  ...
  Scenario: manifest-validation#test111 titles with invalid value
    Given I have a metadata file called "test111-metadata.json"
  ...
  Scenario: manifest-validation#test112 titles with non-string array values
    Given I have a metadata file called "test112-metadata.json"
  ...
  Scenario: manifest-validation#test113 invalid suppressOutput
    Given I have a metadata file called "test113-metadata.json"
  ...
  Scenario: manifest-validation#test114 invalid name
    Given I have a metadata file called "test114-metadata.json"
  ...
  Scenario: manifest-validation#test115 invalid virtual
    Given I have a metadata file called "test115-metadata.json"
  ...
  Scenario: manifest-validation#test117 file-metadata not referencing file
    Given I have a CSV file called "test117.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test117.csv"
    And I have a file called "test117.csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test117.csv-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
    And there is no file at the url "https://w3c.github.io/csvw/tests/csv-metadata.json"
    When I carry out CSVW validation
    Then there should not be errors
  ...
  Scenario: manifest-validation#test119 directory-metadata not referencing file
    Given I have a CSV file called "test119/action.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test119/action.csv"
    And I have a file called "test119/csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test119/csv-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
  ...
  Scenario: manifest-validation#test120 link-metadata not referencing file
    ...
    And I have a file called "test120-linked-metadata.json" at the url "https://w3c.github.io/csvw/tests/test120-linked-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
  ...
  Scenario: manifest-validation#test121 user-metadata not referencing file
    Given I have a CSV file called "test121.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test121.csv"
    And I have a metadata file called "test121-user-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test121-user-metadata.json"
    And I have a file called "test121-ref.csv" at the url "https://w3c.github.io/csvw/tests/test121-ref.csv"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
  ...
  Scenario: manifest-validation#test122 link-metadata not describing file uses file-metadata
    ...
    And I have a file called "test122.csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test122.csv-metadata.json"
    And I have a file called "test122-linked-metadata.json" at the url "https://w3c.github.io/csvw/tests/test122-linked-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
    And there is no file at the url "https://w3c.github.io/csvw/tests/csv-metadata.json"
    When I carry out CSVW validation
    Then there should not be errors
  ...
  Scenario: manifest-validation#test123 file-metadata not describing file uses directory-metadata
    Given I have a CSV file called "test123/action.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test123/action.csv"
    And I have a file called "test123/action.csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test123/action.csv-metadata.json"
    And I have a file called "test123/csv-metadata.json" at the url "https://w3c.github.io/csvw/tests/test123/csv-metadata.json"
    And there is no file at the url "https://w3c.github.io/.well-known/csvm"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test124 metadata with columns not matching csv titles
    Given I have a CSV file called "tree-ops.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/tree-ops.csv"
    And I have a metadata file called "test124-user-metadata.json"
  ...
  Scenario: manifest-validation#test125 required column with empty cell
    Given I have a metadata file called "test125-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test125-metadata.json"
    And I have a file called "test125.csv" at the url "https://w3c.github.io/csvw/tests/test125.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test126 required column with cell matching null
    Given I have a metadata file called "test126-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test126-metadata.json"
    And I have a file called "test126.csv" at the url "https://w3c.github.io/csvw/tests/test126.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test127 incompatible table
    Given I have a metadata file called "test127-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test127-metadata.json"
    And I have a file called "test127.csv" at the url "https://w3c.github.io/csvw/tests/test127.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test128 duplicate column names
    Given I have a metadata file called "test128-metadata.json"
  ...
  Scenario: manifest-validation#test129 columnn name as integer
    Given I have a metadata file called "test129-metadata.json"
  ...
  Scenario: manifest-validation#test130 invalid column name
    Given I have a metadata file called "test130-metadata.json"
  ...
  Scenario: manifest-validation#test131 invalid column name
    Given I have a metadata file called "test131-metadata.json"
  ...
  Scenario: manifest-validation#test132 name annotation from title percent encoded
    Given I have a metadata file called "test132-metadata.json"
  ...
  Scenario: manifest-validation#test133 virtual before non-virtual
    Given I have a metadata file called "test133-metadata.json"
  ...
  Scenario: manifest-validation#test134 context in common property
    Given I have a metadata file called "test134-metadata.json"
  ...
  Scenario: manifest-validation#test135 @list value
    Given I have a metadata file called "test135-metadata.json"
  ...
  Scenario: manifest-validation#test136 @set value
    Given I have a metadata file called "test136-metadata.json"
  ...
  Scenario: manifest-validation#test137 @type out of range (as datatype)
    Given I have a metadata file called "test137-metadata.json"
  ...
  Scenario: manifest-validation#test138 @type out of range (as node type)
    Given I have a metadata file called "test138-metadata.json"
  ...
  Scenario: manifest-validation#test139 @type out of range (as node type) - string
    Given I have a metadata file called "test139-metadata.json"
  ...
  Scenario: manifest-validation#test140 @type out of range (as node type) - integer
    Given I have a metadata file called "test140-metadata.json"
  ...
  Scenario: manifest-validation#test141 @id out of range (as node type) - bnode
    Given I have a metadata file called "test141-metadata.json"
  ...
  Scenario: manifest-validation#test142 @value with @language and @type
    Given I have a metadata file called "test142-metadata.json"
  ...
  Scenario: manifest-validation#test143 @value with extra properties
    Given I have a metadata file called "test143-metadata.json"
  ...
  Scenario: manifest-validation#test144 @language outside of @value
    Given I have a metadata file called "test144-metadata.json"
  ...
  Scenario: manifest-validation#test145 @value with invalid @language
    Given I have a metadata file called "test145-metadata.json"
  ...
  Scenario: manifest-validation#test146 Invalid faux-keyword
    Given I have a metadata file called "test146-metadata.json"
  ...
  Scenario: manifest-validation#test147 title incompatible with title on case
    Given I have a metadata file called "test147-metadata.json"
  ...
  Scenario: manifest-validation#test149 title compatible with title on less specific language
    Given I have a metadata file called "test149-metadata.json"
  ...
  Scenario: manifest-validation#test150 non-builtin datatype (datatype value)
    Given I have a metadata file called "test150-metadata.json"
  ...
  Scenario: manifest-validation#test151 non-builtin datatype (base value)
    Given I have a metadata file called "test151-metadata.json"
  ...
  Scenario: manifest-validation#test152 string format (valid combinations)
    Given I have a metadata file called "test152-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test152-metadata.json"
    And I have a file called "test152.csv" at the url "https://w3c.github.io/csvw/tests/test152.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test153 string format (bad format string)
    Given I have a metadata file called "test153-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test153-metadata.json"
    And I have a file called "test153.csv" at the url "https://w3c.github.io/csvw/tests/test153.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test154 string format (value not matching format)
    Given I have a metadata file called "test154-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test154-metadata.json"
    And I have a file called "test154.csv" at the url "https://w3c.github.io/csvw/tests/test154.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test155 number format (valid combinations)
    Given I have a metadata file called "test155-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test155-metadata.json"
    And I have a file called "test155.csv" at the url "https://w3c.github.io/csvw/tests/test155.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test156 number format (bad format string)
    Given I have a metadata file called "test156-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test156-metadata.json"
    And I have a file called "test156.csv" at the url "https://w3c.github.io/csvw/tests/test156.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test157 number format (value not matching format)
    Given I have a metadata file called "test157-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test157-metadata.json"
    And I have a file called "test157.csv" at the url "https://w3c.github.io/csvw/tests/test157.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test158 number format (valid combinations)
    Given I have a metadata file called "test158-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test158-metadata.json"
    And I have a file called "test158.csv" at the url "https://w3c.github.io/csvw/tests/test158.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test159 number format (bad pattern format string)
    Given I have a metadata file called "test159-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test159-metadata.json"
    And I have a file called "test159.csv" at the url "https://w3c.github.io/csvw/tests/test159.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test160 number format (not matching values with pattern)
    Given I have a metadata file called "test160-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test160-metadata.json"
    And I have a file called "test160.csv" at the url "https://w3c.github.io/csvw/tests/test160.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test161 number format (not matching values without pattern)
    Given I have a metadata file called "test161-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test161-metadata.json"
    And I have a file called "test161.csv" at the url "https://w3c.github.io/csvw/tests/test161.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test162 numeric format (consecutive groupChar)
    Given I have a metadata file called "test162-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test162-metadata.json"
    And I have a file called "test162.csv" at the url "https://w3c.github.io/csvw/tests/test162.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test163 integer datatype with decimalChar
    Given I have a metadata file called "test163-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test163-metadata.json"
    And I have a file called "test163.csv" at the url "https://w3c.github.io/csvw/tests/test163.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test164 decimal datatype with exponent
    Given I have a metadata file called "test164-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test164-metadata.json"
    And I have a file called "test164.csv" at the url "https://w3c.github.io/csvw/tests/test164.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test165 decimal type with NaN
    Given I have a metadata file called "test165-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test165-metadata.json"
    And I have a file called "test165.csv" at the url "https://w3c.github.io/csvw/tests/test165.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test166 decimal type with INF
    Given I have a metadata file called "test166-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test166-metadata.json"
    And I have a file called "test166.csv" at the url "https://w3c.github.io/csvw/tests/test166.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test167 decimal type with -INF
    Given I have a metadata file called "test167-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test167-metadata.json"
    And I have a file called "test167.csv" at the url "https://w3c.github.io/csvw/tests/test167.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test168 decimal with implicit groupChar
    Given I have a metadata file called "test168-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test168-metadata.json"
    And I have a file called "test168.csv" at the url "https://w3c.github.io/csvw/tests/test168.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test169 invalid decimal
    Given I have a metadata file called "test169-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test169-metadata.json"
    And I have a file called "test169.csv" at the url "https://w3c.github.io/csvw/tests/test169.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test170 decimal with percent
    Given I have a metadata file called "test170-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test170-metadata.json"
    And I have a file called "test170.csv" at the url "https://w3c.github.io/csvw/tests/test170.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test171 decimal with per-mille
    Given I have a metadata file called "test171-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test171-metadata.json"
    And I have a file called "test171.csv" at the url "https://w3c.github.io/csvw/tests/test171.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test172 invalid byte
    Given I have a metadata file called "test172-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test172-metadata.json"
    And I have a file called "test172.csv" at the url "https://w3c.github.io/csvw/tests/test172.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test173 invald unsignedLong
    Given I have a metadata file called "test173-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test173-metadata.json"
    And I have a file called "test173.csv" at the url "https://w3c.github.io/csvw/tests/test173.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test174 invalid unsignedShort
    Given I have a metadata file called "test174-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test174-metadata.json"
    And I have a file called "test174.csv" at the url "https://w3c.github.io/csvw/tests/test174.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test175 invalid unsignedByte
    Given I have a metadata file called "test175-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test175-metadata.json"
    And I have a file called "test175.csv" at the url "https://w3c.github.io/csvw/tests/test175.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test176 invalid positiveInteger
    Given I have a metadata file called "test176-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test176-metadata.json"
    And I have a file called "test176.csv" at the url "https://w3c.github.io/csvw/tests/test176.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test177 invalid negativeInteger
    Given I have a metadata file called "test177-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test177-metadata.json"
    And I have a file called "test177.csv" at the url "https://w3c.github.io/csvw/tests/test177.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test178 invalid nonPositiveInteger
    Given I have a metadata file called "test178-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test178-metadata.json"
    And I have a file called "test178.csv" at the url "https://w3c.github.io/csvw/tests/test178.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test179 invalid nonNegativeInteger
    Given I have a metadata file called "test179-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test179-metadata.json"
    And I have a file called "test179.csv" at the url "https://w3c.github.io/csvw/tests/test179.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test180 invalid double
    Given I have a metadata file called "test180-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test180-metadata.json"
    And I have a file called "test180.csv" at the url "https://w3c.github.io/csvw/tests/test180.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test181 invalid number
    Given I have a metadata file called "test181-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test181-metadata.json"
    And I have a file called "test181.csv" at the url "https://w3c.github.io/csvw/tests/test181.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test182 invalid float
    Given I have a metadata file called "test182-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test182-metadata.json"
    And I have a file called "test182.csv" at the url "https://w3c.github.io/csvw/tests/test182.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test183 boolean format (valid combinations)
    Given I have a metadata file called "test183-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test183-metadata.json"
    And I have a file called "test183.csv" at the url "https://w3c.github.io/csvw/tests/test183.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test184 boolean format (bad format string)
    Given I have a metadata file called "test184-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test184-metadata.json"
    And I have a file called "test184.csv" at the url "https://w3c.github.io/csvw/tests/test184.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test185 boolean format (value not matching format)
    Given I have a metadata file called "test185-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test185-metadata.json"
    And I have a file called "test185.csv" at the url "https://w3c.github.io/csvw/tests/test185.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test186 boolean format (not matching datatype)
    Given I have a metadata file called "test186-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test186-metadata.json"
    And I have a file called "test186.csv" at the url "https://w3c.github.io/csvw/tests/test186.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test187 date format (valid native combinations)
    Given I have a metadata file called "test187-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test187-metadata.json"
    And I have a file called "test187.csv" at the url "https://w3c.github.io/csvw/tests/test187.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test188 date format (valid date combinations with formats)
    Given I have a metadata file called "test188-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test188-metadata.json"
    And I have a file called "test188.csv" at the url "https://w3c.github.io/csvw/tests/test188.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test189 date format (valid time combinations with formats)
    Given I have a metadata file called "test189-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test189-metadata.json"
    And I have a file called "test189.csv" at the url "https://w3c.github.io/csvw/tests/test189.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test190 date format (valid dateTime combinations with formats)
    Given I have a metadata file called "test190-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test190-metadata.json"
    And I have a file called "test190.csv" at the url "https://w3c.github.io/csvw/tests/test190.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test191 date format (bad format string)
    Given I have a metadata file called "test191-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test191-metadata.json"
    And I have a file called "test191.csv" at the url "https://w3c.github.io/csvw/tests/test191.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test192 date format (value not matching format)
    Given I have a metadata file called "test192-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test192-metadata.json"
    And I have a file called "test192.csv" at the url "https://w3c.github.io/csvw/tests/test192.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test193 duration format (valid combinations)
    Given I have a metadata file called "test193-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test193-metadata.json"
    And I have a file called "test193.csv" at the url "https://w3c.github.io/csvw/tests/test193.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test194 duration format (value not matching format)
    Given I have a metadata file called "test194-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test194-metadata.json"
    And I have a file called "test194.csv" at the url "https://w3c.github.io/csvw/tests/test194.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test195 values with matching length
    Given I have a metadata file called "test195-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test195-metadata.json"
    And I have a file called "test195.csv" at the url "https://w3c.github.io/csvw/tests/test195.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test196 values with wrong length
    Given I have a metadata file called "test196-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test196-metadata.json"
    And I have a file called "test196.csv" at the url "https://w3c.github.io/csvw/tests/test196.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test197 values with wrong maxLength
    Given I have a metadata file called "test197-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test197-metadata.json"
    And I have a file called "test197.csv" at the url "https://w3c.github.io/csvw/tests/test197.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test198 values with wrong minLength
    Given I have a metadata file called "test198-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test198-metadata.json"
    And I have a file called "test198.csv" at the url "https://w3c.github.io/csvw/tests/test198.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test199 length less than minLength
    Given I have a metadata file called "test199-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test199-metadata.json"
    And I have a file called "test199.csv" at the url "https://w3c.github.io/csvw/tests/test199.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test200 length > maxLength
    Given I have a metadata file called "test200-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test200-metadata.json"
    And I have a file called "test200.csv" at the url "https://w3c.github.io/csvw/tests/test200.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test201 length on date
    Given I have a metadata file called "test201-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test201-metadata.json"
    And I have a file called "test201.csv" at the url "https://w3c.github.io/csvw/tests/test201.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test202 float matching constraints
    Given I have a metadata file called "test202-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test202-metadata.json"
    And I have a file called "test202.csv" at the url "https://w3c.github.io/csvw/tests/test202.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test203 float value constraint not matching minimum
    Given I have a metadata file called "test203-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test203-metadata.json"
    And I have a file called "test203.csv" at the url "https://w3c.github.io/csvw/tests/test203.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test204 float value constraint not matching maximum
    Given I have a metadata file called "test204-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test204-metadata.json"
    And I have a file called "test204.csv" at the url "https://w3c.github.io/csvw/tests/test204.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test205 float value constraint not matching minInclusive
    Given I have a metadata file called "test205-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test205-metadata.json"
    And I have a file called "test205.csv" at the url "https://w3c.github.io/csvw/tests/test205.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test206 float value constraint not matching minExclusive
    Given I have a metadata file called "test206-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test206-metadata.json"
    And I have a file called "test206.csv" at the url "https://w3c.github.io/csvw/tests/test206.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test207 float value constraint not matching maxInclusive
    Given I have a metadata file called "test207-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test207-metadata.json"
    And I have a file called "test207.csv" at the url "https://w3c.github.io/csvw/tests/test207.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test208 float value constraint not matching maxExclusive
    Given I have a metadata file called "test208-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test208-metadata.json"
    And I have a file called "test208.csv" at the url "https://w3c.github.io/csvw/tests/test208.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test209 date matching constraints
    Given I have a metadata file called "test209-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test209-metadata.json"
    And I have a file called "test209.csv" at the url "https://w3c.github.io/csvw/tests/test209.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test210 date value constraint not matching minimum
    Given I have a metadata file called "test210-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test210-metadata.json"
    And I have a file called "test210.csv" at the url "https://w3c.github.io/csvw/tests/test210.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test211 date value constraint not matching maximum
    Given I have a metadata file called "test211-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test211-metadata.json"
    And I have a file called "test211.csv" at the url "https://w3c.github.io/csvw/tests/test211.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test212 date value constraint not matching minInclusive
    Given I have a metadata file called "test212-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test212-metadata.json"
    And I have a file called "test212.csv" at the url "https://w3c.github.io/csvw/tests/test212.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test213 date value constraint not matching minExclusive
    Given I have a metadata file called "test213-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test213-metadata.json"
    And I have a file called "test213.csv" at the url "https://w3c.github.io/csvw/tests/test213.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test214 date value constraint not matching maxInclusive
    Given I have a metadata file called "test214-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test214-metadata.json"
    And I have a file called "test214.csv" at the url "https://w3c.github.io/csvw/tests/test214.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test215 date value constraint not matching maxExclusive
    Given I have a metadata file called "test215-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test215-metadata.json"
    And I have a file called "test215.csv" at the url "https://w3c.github.io/csvw/tests/test215.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test216 minInclusive and minExclusive
    Given I have a metadata file called "test216-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test216-metadata.json"
    And I have a file called "test216.csv" at the url "https://w3c.github.io/csvw/tests/test216.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test217 maxInclusive and maxExclusive
    Given I have a metadata file called "test217-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test217-metadata.json"
    And I have a file called "test217.csv" at the url "https://w3c.github.io/csvw/tests/test217.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test218 maxInclusive less than minInclusive
    Given I have a metadata file called "test218-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test218-metadata.json"
    And I have a file called "test218.csv" at the url "https://w3c.github.io/csvw/tests/test218.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test219 maxExclusive = minInclusive
    Given I have a metadata file called "test219-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test219-metadata.json"
    And I have a file called "test219.csv" at the url "https://w3c.github.io/csvw/tests/test219.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test220 maxExclusive less than minExclusive
    Given I have a metadata file called "test220-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test220-metadata.json"
    And I have a file called "test220.csv" at the url "https://w3c.github.io/csvw/tests/test220.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test221 maxInclusive = minExclusive
    Given I have a metadata file called "test221-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test221-metadata.json"
    And I have a file called "test221.csv" at the url "https://w3c.github.io/csvw/tests/test221.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test222 string datatype with minimum
    Given I have a metadata file called "test222-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test222-metadata.json"
    And I have a file called "test222.csv" at the url "https://w3c.github.io/csvw/tests/test222.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test223 string datatype with maxium
    Given I have a metadata file called "test223-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test223-metadata.json"
    And I have a file called "test223.csv" at the url "https://w3c.github.io/csvw/tests/test223.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test224 string datatype with minInclusive
    Given I have a metadata file called "test224-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test224-metadata.json"
    And I have a file called "test224.csv" at the url "https://w3c.github.io/csvw/tests/test224.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test225 string datatype with maxInclusive
    Given I have a metadata file called "test225-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test225-metadata.json"
    And I have a file called "test225.csv" at the url "https://w3c.github.io/csvw/tests/test225.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test226 string datatype with minExclusive
    Given I have a metadata file called "test226-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test226-metadata.json"
    And I have a file called "test226.csv" at the url "https://w3c.github.io/csvw/tests/test226.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test227 string datatype with maxExclusive
    Given I have a metadata file called "test227-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test227-metadata.json"
    And I have a file called "test227.csv" at the url "https://w3c.github.io/csvw/tests/test227.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test228 length with separator
    Given I have a metadata file called "test228-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test228-metadata.json"
    And I have a file called "test228.csv" at the url "https://w3c.github.io/csvw/tests/test228.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test229 matching minLength with separator
    Given I have a metadata file called "test229-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test229-metadata.json"
    And I have a file called "test229.csv" at the url "https://w3c.github.io/csvw/tests/test229.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test230 failing minLength with separator
    Given I have a metadata file called "test230-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test230-metadata.json"
    And I have a file called "test230.csv" at the url "https://w3c.github.io/csvw/tests/test230.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test231 single column primaryKey success
    Given I have a metadata file called "test231-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test231-metadata.json"
    And I have a file called "test231.csv" at the url "https://w3c.github.io/csvw/tests/test231.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test232 single column primaryKey violation
    Given I have a metadata file called "test232-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test232-metadata.json"
    And I have a file called "test232.csv" at the url "https://w3c.github.io/csvw/tests/test232.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test233 multiple column primaryKey success
    Given I have a metadata file called "test233-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test233-metadata.json"
    And I have a file called "test233.csv" at the url "https://w3c.github.io/csvw/tests/test233.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test234 multiple column primaryKey violation
    Given I have a metadata file called "test234-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test234-metadata.json"
    And I have a file called "test234.csv" at the url "https://w3c.github.io/csvw/tests/test234.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test235 rowTitles on one column
    Given I have a metadata file called "test235-metadata.json"
  ...
  Scenario: manifest-validation#test236 rowTitles on multiple columns
    Given I have a metadata file called "test236-metadata.json"
  ...
  Scenario: manifest-validation#test237 rowTitles on one column (minimal)
    Given I have a metadata file called "test237-metadata.json"
  ...
  Scenario: manifest-validation#test238 datatype value an absolute URL
    Given I have a metadata file called "test238-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test238-metadata.json"
    And I have a file called "test238.csv" at the url "https://w3c.github.io/csvw/tests/test238.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should be warnings
  ...
  Scenario: manifest-validation#test242 datatype @id an absolute URL
    Given I have a metadata file called "test242-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test242-metadata.json"
    And I have a file called "test242.csv" at the url "https://w3c.github.io/csvw/tests/test242.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test243 invalid datatype @id
    Given I have a metadata file called "test243-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test243-metadata.json"
    And I have a file called "test243.csv" at the url "https://w3c.github.io/csvw/tests/test243.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test244 invalid datatype @id
    Given I have a metadata file called "test244-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test244-metadata.json"
    And I have a file called "test244.csv" at the url "https://w3c.github.io/csvw/tests/test244.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test245 date format (valid time combinations with formats and milliseconds)
    Given I have a metadata file called "test245-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test245-metadata.json"
    And I have a file called "test245.csv" at the url "https://w3c.github.io/csvw/tests/test245.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test246 date format (valid dateTime combinations with formats and milliseconds)
    Given I have a metadata file called "test246-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test246-metadata.json"
    And I have a file called "test246.csv" at the url "https://w3c.github.io/csvw/tests/test246.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test247 date format (extra milliseconds)
    Given I have a metadata file called "test247-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test247-metadata.json"
    And I have a file called "test247.csv" at the url "https://w3c.github.io/csvw/tests/test247.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test248 Unicode in non-Normalized form
    Given I have a metadata file called "test248-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test248-metadata.json"
    And I have a file called "test248.csv" at the url "https://w3c.github.io/csvw/tests/test248.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test249 http normalization
    Given I have a CSV file called "test249.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test249.csv"
    And I have a metadata file called "test249-user-metadata.json"
  ...
  Scenario: manifest-validation#test250 valid case
    Given I have a metadata file called "test250-metadata.json"
  ...
  Scenario: manifest-validation#test251 missing source reference
    Given I have a metadata file called "test251-metadata.json"
  ...
  Scenario: manifest-validation#test252 missing destination reference column
    Given I have a metadata file called "test252-metadata.json"
  ...
  Scenario: manifest-validation#test253 missing destination table
    Given I have a metadata file called "test253-metadata.json"
  ...
  Scenario: manifest-validation#test254 foreign key single column same table
    Given I have a metadata file called "test254-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test254-metadata.json"
    And I have a file called "test254.csv" at the url "https://w3c.github.io/csvw/tests/test254.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test255 foreign key single column different table
    Given I have a metadata file called "test255-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test255-metadata.json"
    And I have a file called "countries.csv" at the url "https://w3c.github.io/csvw/tests/countries.csv"
    And I have a file called "test255.csv" at the url "https://w3c.github.io/csvw/tests/test255.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test256 foreign key multiple columns
    Given I have a metadata file called "test256-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test256-metadata.json"
    And I have a file called "countries.csv" at the url "https://w3c.github.io/csvw/tests/countries.csv"
    And I have a file called "test256.csv" at the url "https://w3c.github.io/csvw/tests/test256.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test257 foreign key no referenced row
    Given I have a metadata file called "test257-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test257-metadata.json"
    And I have a file called "test257.csv" at the url "https://w3c.github.io/csvw/tests/test257.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test258 foreign key multiple referenced rows
    Given I have a metadata file called "test258-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test258-metadata.json"
    And I have a file called "test258.csv" at the url "https://w3c.github.io/csvw/tests/test258.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test259 tree-ops example with csvm.json (w3.org/.well-known/csvm)
    Given I have a CSV file called "test259/tree-ops.csv"
    ...
    And I have a file called "test259/csvm.json" at the url "https://w3c.github.io/csvw/tests/test259/csvm.json"
  ...
  Scenario: manifest-validation#test260 tree-ops example with {+url}.json (w3.org/.well-known/csvm)
    Given I have a CSV file called "test260/tree-ops.csv"
    And it is stored at the url "https://w3c.github.io/csvw/tests/test260/tree-ops.csv"
    And I have a file called "w3.org/.well-known/csvm" at the url "https://www.w3.org/.well-known/csvm"
    And I have a file called "test260/tree-ops.csv.json" at the url "https://w3c.github.io/csvw/tests/test260/tree-ops.csv.json"
  ...
  Scenario: manifest-validation#test261 maxLength less than minLength
    Given I have a metadata file called "test261-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test261-metadata.json"
    And I have a file called "test261.csv" at the url "https://w3c.github.io/csvw/tests/test261.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test263 @type on a common property can be a built-in type
    Given I have a metadata file called "test263-metadata.json"
  ...
  Scenario: manifest-validation#test264 @type on a common property can be a CURIE if the prefix is one of the built-in ones
    Given I have a metadata file called "test264-metadata.json"
  ...
  Scenario: manifest-validation#test266 `null` contains an array of (valid) string & (invalid) numeric values
    Given I have a metadata file called "test266-metadata.json"
  ...
  Scenario: manifest-validation#test267 @id on datatype is invalid (eg starts with _:)
    Given I have a metadata file called "test267-metadata.json"
  ...
  Scenario: manifest-validation#test268 `base` missing on datatype (defaults to string)
    Given I have a metadata file called "test268-metadata.json"
  ...
  Scenario: manifest-validation#test269 `format` for a boolean datatype is a string but in the wrong form (eg YN)
    Given I have a metadata file called "test269-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test269-metadata.json"
    And I have a file called "test269.csv" at the url "https://w3c.github.io/csvw/tests/test269.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test270 transformation includes an invalid property (eg foo)
    Given I have a metadata file called "test270-metadata.json"
  ...
  Scenario: manifest-validation#test271 foreign key includes an invalid property (eg `dc:description`)
    Given I have a metadata file called "test271-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test271-metadata.json"
    And I have a file called "test271.csv" at the url "https://w3c.github.io/csvw/tests/test271.csv"
    And I have a file called "countries.csv" at the url "https://w3c.github.io/csvw/tests/countries.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test272 foreign key reference includes an invalid property (eg `dc:description`)
    Given I have a metadata file called "test272-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test272-metadata.json"
    And I have a file called "test272.csv" at the url "https://w3c.github.io/csvw/tests/test272.csv"
    And I have a file called "countries.csv" at the url "https://w3c.github.io/csvw/tests/countries.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test273 `@base` set in `@context` overriding eg CSV location
    Given I have a metadata file called "test273-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test273-metadata.json"
    And I have a file called "test273/action.csv" at the url "https://w3c.github.io/csvw/tests/test273/action.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test274 `@context` object includes properties other than `@base` and `@language`
    Given I have a metadata file called "test274-metadata.json"
  ...
  Scenario: manifest-validation#test275 property acceptable on column appears on table group
    Given I have a metadata file called "test275-metadata.json"
  ...
  Scenario: manifest-validation#test276 property acceptable on column appears on table
    Given I have a metadata file called "test276-metadata.json"
  ...
  Scenario: manifest-validation#test277 property acceptable on table appears on column
    Given I have a metadata file called "test277-metadata.json"
  ...
  Scenario: manifest-validation#test278 CSV has more headers than there are columns in the metadata
    Given I have a metadata file called "test278-metadata.json"
  ...
  Scenario: manifest-validation#test279 duration not matching xsd pattern
    Given I have a metadata file called "test279-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test279-metadata.json"
    And I have a file called "test279.csv" at the url "https://w3c.github.io/csvw/tests/test279.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test280 dayTimeDuration not matching xsd pattern
    Given I have a metadata file called "test280-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test280-metadata.json"
    And I have a file called "test280.csv" at the url "https://w3c.github.io/csvw/tests/test280.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test281 yearMonthDuration not matching xsd pattern
    Given I have a metadata file called "test281-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test281-metadata.json"
    And I have a file called "test281.csv" at the url "https://w3c.github.io/csvw/tests/test281.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test282 valid number patterns
    Given I have a metadata file called "test282-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test282-metadata.json"
    And I have a file called "test282.csv" at the url "https://w3c.github.io/csvw/tests/test282.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test283 valid number patterns (signs and percent/permille)
    Given I have a metadata file called "test283-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test283-metadata.json"
    And I have a file called "test283.csv" at the url "https://w3c.github.io/csvw/tests/test283.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test284 valid number patterns (grouping)
    Given I have a metadata file called "test284-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test284-metadata.json"
    And I have a file called "test284.csv" at the url "https://w3c.github.io/csvw/tests/test284.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test285 valid number patterns (fractional grouping)
    Given I have a metadata file called "test285-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test285-metadata.json"
    And I have a file called "test285.csv" at the url "https://w3c.github.io/csvw/tests/test285.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test286 invalid ##0 1,234
    Given I have a metadata file called "test286-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test286-metadata.json"
    And I have a file called "test286.csv" at the url "https://w3c.github.io/csvw/tests/test286.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test287 invalid ##0 123.4
    Given I have a metadata file called "test287-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test287-metadata.json"
    And I have a file called "test287.csv" at the url "https://w3c.github.io/csvw/tests/test287.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test288 invalid #,#00 1
    Given I have a metadata file called "test288-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test288-metadata.json"
    And I have a file called "test288.csv" at the url "https://w3c.github.io/csvw/tests/test288.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test289 invalid #,#00 1234
    Given I have a metadata file called "test289-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test289-metadata.json"
    And I have a file called "test289.csv" at the url "https://w3c.github.io/csvw/tests/test289.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test290 invalid #,#00 12,34
    Given I have a metadata file called "test290-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test290-metadata.json"
    And I have a file called "test290.csv" at the url "https://w3c.github.io/csvw/tests/test290.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test291 invalid #,#00 12,34,567
    Given I have a metadata file called "test291-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test291-metadata.json"
    And I have a file called "test291.csv" at the url "https://w3c.github.io/csvw/tests/test291.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test292 invalid #,##,#00 1
    Given I have a metadata file called "test292-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test292-metadata.json"
    And I have a file called "test292.csv" at the url "https://w3c.github.io/csvw/tests/test292.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test293 invalid #,##,#00 1234
    Given I have a metadata file called "test293-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test293-metadata.json"
    And I have a file called "test293.csv" at the url "https://w3c.github.io/csvw/tests/test293.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test294 invalid #,##,#00 12,34
    Given I have a metadata file called "test294-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test294-metadata.json"
    And I have a file called "test294.csv" at the url "https://w3c.github.io/csvw/tests/test294.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test295 invalid #,##,#00 1,234,567
    Given I have a metadata file called "test295-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test295-metadata.json"
    And I have a file called "test295.csv" at the url "https://w3c.github.io/csvw/tests/test295.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test296 invalid #0.# 12.34
    Given I have a metadata file called "test296-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test296-metadata.json"
    And I have a file called "test296.csv" at the url "https://w3c.github.io/csvw/tests/test296.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test297 invalid #0.# 1,234.5
    Given I have a metadata file called "test297-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test297-metadata.json"
    And I have a file called "test297.csv" at the url "https://w3c.github.io/csvw/tests/test297.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test298 invalid #0.0 1
    Given I have a metadata file called "test298-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test298-metadata.json"
    And I have a file called "test298.csv" at the url "https://w3c.github.io/csvw/tests/test298.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test299 invalid #0.0 12.34
    Given I have a metadata file called "test299-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test299-metadata.json"
    And I have a file called "test299.csv" at the url "https://w3c.github.io/csvw/tests/test299.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test300 invalid #0.0# 1
    Given I have a metadata file called "test300-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test300-metadata.json"
    And I have a file called "test300.csv" at the url "https://w3c.github.io/csvw/tests/test300.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test301 invalid #0.0# 12.345
    Given I have a metadata file called "test301-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test301-metadata.json"
    And I have a file called "test301.csv" at the url "https://w3c.github.io/csvw/tests/test301.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test302 invalid #0.0#,# 1
    Given I have a metadata file called "test302-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test302-metadata.json"
    And I have a file called "test302.csv" at the url "https://w3c.github.io/csvw/tests/test302.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test303 invalid #0.0#,# 12.345
    Given I have a metadata file called "test303-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test303-metadata.json"
    And I have a file called "test303.csv" at the url "https://w3c.github.io/csvw/tests/test303.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test304 invalid #0.0#,# 12.34,567
    Given I have a metadata file called "test304-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test304-metadata.json"
    And I have a file called "test304.csv" at the url "https://w3c.github.io/csvw/tests/test304.csv"
    When I carry out CSVW validation
    Then there should be errors
  ...
  Scenario: manifest-validation#test305 multiple values with same subject and property (unordered)
    Given I have a metadata file called "test305-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test305-metadata.json"
    And I have a file called "test305.csv" at the url "https://w3c.github.io/csvw/tests/test305.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test306 multiple values with same subject and property (ordered)
    Given I have a metadata file called "test306-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test306-metadata.json"
    And I have a file called "test306.csv" at the url "https://w3c.github.io/csvw/tests/test306.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test307 multiple values with same subject and property (ordered and unordered)
    Given I have a metadata file called "test307-metadata.json"
    And the metadata is stored at the url "https://w3c.github.io/csvw/tests/test307-metadata.json"
    And I have a file called "test307.csv" at the url "https://w3c.github.io/csvw/tests/test307.csv"
    When I carry out CSVW validation
    Then there should not be errors
    And there should not be warnings
  ...
  Scenario: manifest-validation#test308 invalid datatype string
    Given I have a metadata file called "test308-metadata.json"
